...
public abstract class UTPBuilder{

	public static HashMap<Player,UTPBuilder> building = new HashMap<>();
	...
	public UTPBuilder(Player p, String builderName) {
		this.p = p;
		this.builderName=builderName;
	}

	public void startBuilding(Player p, UTPBuilder builder) {
	...
	public static UTPBuilder getBuilder(Player p) {
		return building.get(p);
	}

	public static void addBuilding(Player p, UTPBuilder builder) {
