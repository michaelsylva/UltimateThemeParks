...
public class FRFrisbee extends Ride{
	...
	Location center = new Location(Bukkit.getWorld("world"),99,90,506);
	Location pivot = new Location(Bukkit.getWorld("world"),99,99,506);
	...
	public void start() {
		...
		setRunning(true);
		task = new FrisbeeRunnable(this).runTaskTimer(MCACore.getPlugin(MCACore.class), 1L, 1L);
	}
